...
public:
	...
	public:
		...
		int AddItem(LPCTSTR lpszText, int image, DWORD exData);
		BOOL SetOnlineImage(DWORD dwID,BOOL bTrue);
		BOOL ModifyItem(DWORD dwID,int image,LPCTSTR lpszText);
...
// Implementation
public:
	BOOL RemoveAItem(int folder,DWORD dwID,BOOL bRefresh=TRUE);
	void SetOfflineState();
	int AddItem(int folder,LPCTSTR lpszText,int image,DWORD exData);
	BOOL SetOnlineImage(DWORD dwID,BOOL bTrue=TRUE);
	BOOL ModifyItem(DWORD dwID,int image,LPCTSTR lpszText);
	BOOL MoveToTail(int folder,int index);
	BOOL MoveToHead(int folder,int index);
...
protected:
	...
	afx_msg void OnGfxGroupicon();
	afx_msg void OnGfxBackcicon();
	afx_msg void OnGfxFontcicon();
	//}}AFX_MSG
