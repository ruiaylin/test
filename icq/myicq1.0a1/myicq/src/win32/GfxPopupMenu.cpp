...
void CGfxPopupMenu::modifyMenu(UINT itemId, UINT bitmap, BOOL byCmd)
{
	int index;
...
void CGfxPopupMenu::modifyMenu(UINT itemId, HICON icon)
{
	int index;
...
void CGfxPopupMenu::modifyMenuInternal(UINT itemId, int imageIndex, BOOL byCmd)
{
	if (byCmd) {
...
void CGfxPopupMenu::insertMenu(UINT id, UINT bitmap, LPCTSTR str, UINT pos)
{
	InsertMenu(pos, MF_BYPOSITION | MF_STRING, id, str);
	modifyMenu(id, bitmap);
}

void CGfxPopupMenu::insertMenu(UINT id, UINT bitmap, UINT strID, UINT pos)
{
	CString str;
	str.LoadString(strID);
	insertMenu(id, bitmap, str, pos);
}

void CGfxPopupMenu::setVertBitmap(UINT bitmap)
{
