...
typedef struct lisk_buf_tag {
	u4		size;
	vp		data;
} lisk_buf_t, *lisk_buf_p, lisk_buf_a[1];
/**
 ...
 * @data		: key content
 **/
typedef	lisk_buf_t				lisk_key_t;
typedef	lisk_buf_p				lisk_key_p;
typedef	lisk_buf_a				lisk_key_a;
 ...
 * @data		: value content
 **/
typedef	lisk_buf_t				lisk_value_t;
typedef	lisk_buf_p				lisk_value_p;
typedef	lisk_buf_a				lisk_value_a;
