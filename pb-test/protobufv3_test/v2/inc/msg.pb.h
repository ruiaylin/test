...
class Message : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_hilarity() const;
  ...
  inline bool has_height_in_cm() const;
  ...
  inline bool has_true_scotsman() const;
 ...
 private:
  ...
  inline void set_has_hilarity();
  inline void clear_has_hilarity();
  inline void set_has_height_in_cm();
  inline void clear_has_height_in_cm();
  inline void set_has_data();
  inline void clear_has_data();
  inline void set_has_result_count();
  inline void clear_has_result_count();
  inline void set_has_true_scotsman();
  inline void clear_has_true_scotsman();
...
inline void Message::set_hilarity(::proto3_proto::Message_Humour value) {
  assert(::proto3_proto::Message_Humour_IsValid(value));
  set_has_hilarity();
  hilarity_ = value;
